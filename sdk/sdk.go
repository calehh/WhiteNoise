...
type Client interface {
	GetMainNetPeers(cnt int) []peer.ID
	Register(proxy core.PeerID) error
	Dial(remoteID string) (net.Conn, string, error)
	GetCircuit(sessionID string) (net.Conn, bool)
...
func (sdk *WhiteNoiseClient) Dial(remoteID string) (*secure.SecureSession, string, error) {
...
func (sdk *WhiteNoiseClient) GetCircuit(sessionID string) (*secure.SecureSession, bool) {
